...
namespace MongoDataAccessAdapter
{
    ...
    public class IdGenerator : IEnumerable
    {
        ...
        private static readonly DefaultTimeSource defaulttimesource = new DefaultTimeSource();
        ...
        private readonly DefaultTimeSource _timesource;
        ...
        /// Thrown when GeneratorId or Sequence masks are >31 bit, GeneratorId exceeds maximum value or epoch in future.
        /// </exception>
        public IdGenerator(int generatorId, DateTime epoch, MaskConfig maskConfig, DefaultTimeSource timeSource)
        {
            if (maskConfig == null)
        ...
        /// no other choice. Prefer to specify generator id's via configuration file or other means instead.
        /// </remarks>
        public static IdGenerator GetMachineSpecificGenerator(DateTime epoch, MaskConfig maskConfig, DefaultTimeSource timeSource)
        {
        ...
        /// case prefer to explicitly set the generator id's via configuration file or other means instead.
        /// </remarks>
        public static IdGenerator GetThreadSpecificGenerator(DateTime epoch, MaskConfig maskConfig, DefaultTimeSource timeSource)
        {
